...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    public SecurityConfig(JwtAuthenticationFilter jwtAuthenticationFilter, JwtExceptionFilter jwtExceptionFilter, CustomAccessDeniedHandler customAccessDeniedHandler, CustomAuthenticationEntryPoint customAuthenticationEntryPoint){
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/api/user/login", "/api/user/refresh", "/api/user/login/phone").permitAll()
                .antMatchers("/api/seller/login", "/api/seller/refresh", "/api/seller/signup", "/api/seller/email", "/api/seller/emailConfirm", "/api/seller/search/id", "/api/seller/search/passwd", "/api/seller/passwd").permitAll()
                .antMatchers("/api/admin/refresh").permitAll()
